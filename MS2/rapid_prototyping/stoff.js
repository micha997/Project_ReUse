...
var wintermodel_1layer = {respiratory_activity_low:7,
...
var wintermodel_1layer_alternative = {respiratory_activity_low:7,
                         respiratory_activity_high:10,
                         warmth_low:0,
                         warmth_high:0,
                         moisture_pickup_low:0,
...
var wintermodel_2layer = {respiratory_activity_low:0,
...
var wintermodel_2layer_alternative = {respiratory_activity_low:7,
                          respiratory_activity_high:10,
                          warmth_low:0,
                          warmth_high:0,
                          moisture_pickup_low:0,
...
var wintermodel_3layer = {respiratory_activity_low:0,
...
var wintermodel_3layer_alternative = {respiratory_activity_low:4,
                          respiratory_activity_high:10,
                          warmth_low:0,
                          warmth_high:0,
...
var layer1 = calcLayerClothing(wintermodel_1layer,clothing,charac);
if (layer1 == 0) {
  layer1 = calcLayerClothing(wintermodel_1layer_alternative,clothing,charac);
  if (layer1 == 0) {
      console.log("There is no clothing for layer 1 winter!");
  }
}
var layer2 = calcLayerClothing(wintermodel_2layer,clothing,charac);
if (layer2 == 0) {
  layer2 = calcLayerClothing(wintermodel_2layer_alternative,clothing,charac);
  if (layer2 == 0) {
      console.log("There is no clothing for layer 3 winter!");
  }
}
var layer3 = calcLayerClothing(wintermodel_3layer,clothing,charac);
if (layer3 == 0) {
  layer3 = calcLayerClothing(wintermodel_3layer_alternative,clothing,charac);
  if (layer3 == 0) {
      console.log("There is no clothing for layer 3 winter!");
  }
}
